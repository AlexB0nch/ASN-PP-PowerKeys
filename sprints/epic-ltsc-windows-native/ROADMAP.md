...
| **S10** | [`sprint-10-ltsc-slides-settings/`](../sprint-10-ltsc-slides-settings/) | **In Progress** | Slides + 9 None unlock + Settings UI + Color picker | S10-005 last |
...
Последняя задача: **S10-005** Color picker COM panel (закрытие спринта → M3 Feature beta).
