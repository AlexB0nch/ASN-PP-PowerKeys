...
> Architect декомпозировал Sprint 05 (2026-06-28). Старт: **S05-002 In Progress**.
...
| S05-002 | Snap-to-grid 0.1 cm (Core + layout apply) | Core + Api + AddIn + Tests | **In Progress** | #33 |
