...
Track 0 **не заменяет** native line для offline и 9 None-команд. Чеклист: **[`05-ltsc-web-addin-central-deploy.md`](./05-ltsc-web-addin-central-deploy.md)** (задача **S07-004**).
