...
public static class CommandCatalog
{
    ...
    private static ReadOnlyCollection<CommandDescriptor> BuildAll()
    {
        var list = new List<CommandDescriptor>
        {
            ...
            Host(CommandIds.AlignLeftToRight, "Place to right of anchor", CommandCategory.Alignment, OfficeJsSupport.Full,
                notes: "Position shape so its left edge meets the anchor's right edge."),
            Host(CommandIds.AlignRightToLeft, "Place to left of anchor", CommandCategory.Alignment, OfficeJsSupport.Full),
            Host(CommandIds.AlignTopToBottom, "Place below anchor", CommandCategory.Alignment, OfficeJsSupport.Full),
            Host(CommandIds.AlignBottomToTop, "Place above anchor", CommandCategory.Alignment, OfficeJsSupport.Full),
